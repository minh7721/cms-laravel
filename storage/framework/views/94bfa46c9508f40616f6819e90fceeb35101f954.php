    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea disabled name="content" id="content" class="form-control"><?php echo e($product->content); ?></textarea>
            </div>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/cms-laravel/resources/views/admin/product/preview.blade.php ENDPATH**/ ?>