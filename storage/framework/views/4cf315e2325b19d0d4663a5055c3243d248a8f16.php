            ...
            <div class="mt-8">
                <div class="flex justify-center items-center">
                    <div class="grid lg:grid-flow-col grid-flow-row grid-cols-10 gap-4 justify-items-center">
                        <a href="/<?php echo e($products[0]->name); ?>" class="row-span-4 col-span-12 lg:col-span-6">
                            <img src="/template/admin/dist/img/avatar.png" class="w-full" alt="">
                            <p class="mt-4 font-semibold text-lg tracking-spaceChu"><?php echo e($products[0]->description); ?></p>
                            <div class="flex flex-row text-sm mt-3">
                                ...
                                <p class="mx-2">•</p>
                                <p class="font-normal opacity-50 text-base"><?php echo e($products[0]->updated_At); ?></p>
                            </div>
                            <p class="font-normal opacity-50 text-base"><?php echo e($products[0]->content); ?></p>
                        </a>
